  ...
  return (
    <main className="w-full pt-0 bg-background overflow-x-hidden selection:bg-primary-container selection:text-black font-sans">
            ...
            >
               <div className="md:col-span-8">
                 <p className="text-secondary text-lg md:text-3xl leading-tight font-light max-w-3xl italic">
                   "We don't build tools. We build the infrastructure for elite career synchronization. A high-fidelity bridge between potential and precision."
                 </p>
               </div>
               <div className="md:col-span-4 flex flex-col justify-end">
                  <div className="font-mono text-[9px] text-outline uppercase tracking-[0.4em] mb-4">Calibration_Status</div>
                  <div className="flex gap-2">
                    {[1,2,3,4,5,6,7,8].map(i => <div key={i} className="h-4 w-1.5 bg-primary-container/40 animate-pulse" style={{ animationDelay: `${i*100}ms` }}></div>)}
                  </div>
               </div>
            </motion.div>
          </motion.div>
      ...
      <section className="relative py-32 md:py-64 bg-black-default px-margin-mobile md:px-margin-desktop overflow-hidden border-y border-white/5">
        <div className="absolute top-10 right-10 font-mono text-[200px] text-white/[0.02] font-bold pointer-events-none uppercase">Dossier</div>
        ...
        <div className="max-w-360 mx-auto grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
          ...
          <motion.div 
            ...
            variants={containerVariants}
          >
            <motion.p className="text-primary-container font-mono text-xs uppercase tracking-[0.6em] mb-8" variants={itemVariants}>
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Our mission is to replace generic preparation with architectural precision. We utilize advanced LLM synthesis to mirror the exact adversarial intensity of world-class technical evaluations.
            </motion.p>
            
            <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-12" variants={itemVariants}>
              {[
                ...
                <div key={stat.label}>
                  <div className="font-mono text-[9px] text-outline uppercase tracking-widest mb-3">{stat.label}</div>
                  <div className="font-mono text-white text-lg font-bold tracking-tighter">{stat.val}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
      ...
      <section className="relative py-32 md:py-64 bg-black-default px-margin-mobile md:px-margin-desktop overflow-hidden">
        <div className="max-w-360 mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-8xl font-bold font-mono text-white tracking-tighter uppercase mb-8">Core Protocols</h2>
          ...
          >
            {[
              { title: "Precision First", desc: "Every data point is calibrated against current industry rubrics for maximum relevance." },
              { title: "Zero Placeholder", desc: "We deploy real-world scenarios, not generic simulations. Intensity is our baseline." },
              { title: "Continuous Sync", desc: "Your roadmap evolves in real-time as the platform detects shifts in your performance nodes." }
            ].map((protocol, idx) => (
              <motion.div 
                key={idx} 
                ...
                variants={itemVariants}
              >
                <div className="font-mono text-primary-container text-xs mb-10">RULE_SET_{idx+1}</div>
                <h3 className="text-2xl md:text-4xl font-bold font-mono text-white uppercase mb-8 group-hover:text-primary-container transition-colors">{protocol.title}</h3>
                <p className="text-secondary text-lg font-light leading-relaxed">{protocol.desc}</p>
        ...
        <div className="max-w-360 mx-auto">
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <p className="text-primary-container font-mono text-xs uppercase tracking-[0.4em] mb-8">Personnel_Registry</p>
                ...
                <p className="text-secondary text-xl font-light leading-relaxed italic mb-16">
                   "A singular intelligence focused on engineering your trajectory. We are the silent partners in your most critical hiring loops."
                </p>
                <div className="flex items-center gap-6 p-6 border border-white/10 bg-white/5">
                   ...
                   <div>
                      <div className="font-mono text-white text-sm font-bold uppercase tracking-widest">System Admin</div>
                      <div className="font-mono text-primary-container text-[10px] uppercase">STATUS: ACTIVE // US-WEST-2</div>
                   </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-primary-container/5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-1000" style={{ boxShadow: 'inset 0 0 60px rgba(125, 211, 252, 0.15)' }}></div>
                <img 
                  src={techTeam} 
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            >
               ...
               <span className="font-mono text-[11px] uppercase tracking-[0.8em] text-white">Initialization Complete</span>
            </motion.div>
