    ...
    <main className="w-full pt-0 bg-background overflow-x-hidden selection:bg-primary-container selection:text-black">
      ...
      >
        ...
        <div className="max-w-360 mx-auto relative z-10 w-full text-center">
          ...
          >
            Precision preparation at every scale. Choose the protocol that
              ...
              >
                ...
                <div className="mb-12">
                  <div className="flex items-baseline gap-2 mb-2">
                    <span className="text-5xl md:text-6xl font-bold font-mono text-white tracking-tighter">
                      {plan.price}
                    </span>
                  </div>
                  <div className="font-mono text-[10px] text-secondary uppercase tracking-[0.3em]">
                    {plan.period}
                  </div>
                </div>
                ...
                <ul className="space-y-6 mb-16 border-t border-white/5 pt-10">
                  {plan.features.map((feature, idx) => (
                    ...
                    >
                      <svg
                        className="w-4 h-4 text-primary-container mt-1 shrink-0"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="3"
                      ...
                      <span className="text-secondary text-sm font-light leading-snug">
                        {feature}
                      </span>
                    </motion.li>
                  ))}
              ...
              {[
                ...
                >
                  <h4 className="font-mono text-white text-sm font-bold uppercase tracking-wider mb-4 flex gap-3">
                    <span className="text-primary-container/40">
                      {idx + 1} //
                    </span>{" "}
                    {item.q}
                  </h4>
      ...
      <section className="relative py-32 md:py-48 bg-black-default px-margin-mobile md:px-margin-desktop overflow-hidden border-t border-white/5">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <motion.div
            ...
            transition={{ delay: 1 }}
          >
            {["Plan: Professional", "Uptime: 99.9%", "Encryption: AES-256"].map(
              (stat) => (
                <div
                  key={stat}
                  className="font-mono text-[9px] uppercase tracking-[0.3em] text-outline"
                >
                  {stat}
                </div>
              ),
